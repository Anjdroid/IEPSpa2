/* Timestamp: Wed May 01 17:50:13 PDT 2019 , Code Version: 1556758201261 */
...
function getHostedFileUrl(){var hostedFileUrl="/hm-nuance.html";if(isSameOriginSafe){if(window.parent.v3LanderConfig&&window.parent.v3LanderConfig.hostedFileURL){hostedFileUrl=window.parent.v3LanderConfig.hostedFileURL;}else{try{if(window.parent.opener&&window.parent.opener.v3LanderConfig&&window.parent.opener.v3LanderConfig.hostedFileURL){hostedFileUrl=window.parent.opener.v3LanderConfig.hostedFileURL;}}catch(e){}}}
return window.v3LanderConfig.hostedFileURL||hostedFileUrl;}
function getParentV3Config(){try{var parentOpenerV3LanderConfig=window.parent.opener&&window.parent.opener.v3LanderConfig;}catch(e){}
if(isSameOriginSafe&&(window.parent.v3LanderConfig||parentOpenerV3LanderConfig)){return parentOpenerV3LanderConfig||window.parent.v3LanderConfig;}}
window.v3Lander={FRAME_ID:"inqChatStage",codeVersion:'1556758201261',v3Frame:false,domState:"defer-failed",domReady:false,secureProtocol:function(url){return url.replace(/^HTTPS?:/i,"https:");},hostToPath:{},hostedFileURL:getHostedFileUrl(),isAtHostedFileURL:false,log:function(s){if(typeof console!="undefined"&&console.log){console.log(s);}},FMProxy:{fcns:{},addFcn:function(name,fcnStr){var obj=null;try{obj=eval("({'"+name+"':"+fcnStr+"})");}
...
url=window.location.protocol+url;return url;},establishHostedFileURL:function(){try{var parentOpenerV3LanderConfig=window.parent.opener&&window.parent.opener.v3LanderConfig;}catch(e){}
if(window.v3LanderConfig.hostToPath||(isSameOriginSafe&&((window.parent.v3LanderConfig&&window.parent.v3LanderConfig.hostToPath)||(parentOpenerV3LanderConfig&&parentOpenerV3LanderConfig.hostToPath)))){var hostPaths=window.v3LanderConfig.hostToPath||window.parent.v3LanderConfig.hostToPath||(parentOpenerV3LanderConfig&&parentOpenerV3LanderConfig.hostToPath);for(var i=0,paths=hostPaths;i<paths.length;i++){if(paths[i].domain&&paths[i].hostedFileDirectory){v3Lander.hostToPath[paths[i].domain.toUpperCase()]=paths[i].hostedFileDirectory+v3Lander.hostedFileURL;}}}
...
additionalTags();}
v3Lander.fixV3IFrames(div);function additionalTags(){var divs=div.getElementsByTagName("DIV");for(var ix=divs.length-1;ix>-1;--ix){bdy.appendChild(divs[ix]);}}},loadScript:function(name,useMediaServer,useClientDomain){var bdy=document.getElementsByTagName("BODY");if(bdy&&bdy[0]){var srctag=document.createElement("SC"+"RIPT");try{var parentOpenerV3LanderConfig=window.parent.opener&&window.parent.opener.v3LanderConfig;}catch(e){}
if(false&&useClientDomain){if(isSameOriginSafe&&((window.parent.v3LanderConfig&&window.parent.v3LanderConfig.clientStaticUrl)||(parentOpenerV3LanderConfig&&parentOpenerV3LanderConfig.clientStaticUrl))){window.v3LanderConfig.clientStaticUrl=window.parent.v3LanderConfig.clientStaticUrl||window.parent.opener.v3LanderConfig.clientStaticUrl;}
srctag.src=v3Lander.secureProtocol(window.v3LanderConfig.clientStaticUrl||"")+name;}else if(useMediaServer){srctag.src=v3Lander.secureProtocol(window.v3LanderConfig.vanityDomain||"http://media-eu1.inq.com"||"https://hm.inq.com")+name;}else{srctag.src=v3Lander.secureProtocol(window.v3LanderConfig.vanityDomain||"https://hm.inq.com")+name;}
srctag.type="text/javascript";srctag.charset="utf-8";srctag.language="javascript";bdy[0].appendChild(srctag);}},inqSiteDataFun:null,inqRulesEngineFun:null,mbusToLoad:[],page:null,cgIDs:null,isBupMode:false,isRplMode:false,loadedMbuRuleDataFuns:[],jsonAPIData:null,jsonMbuData:null,requestPage:function(){this.resolvePage();},getPage:function(){return this.page;},getContentGroupIDs:function(){return this.cgIDs;},resolvePage:function(){var requestUrl="/tagserver/launch/resolvePage?siteID=10006112&url="+encodeURIComponent(document.URL)+"&codeVersion="+encodeURIComponent(v3Lander.codeVersion);var overriddenPageId=null;if(window.inqSiteID){overriddenPageId=window.inqSiteID;}else if(window.parent&&window.parent.inqSiteID){overriddenPageId=window.parent.inqSiteID;}
...
v3Lander.testReady();}};v3Lander.hostToPath["AGENT-PREPROD-FP.NINA-NUANCE.COM"]="/hm/hm-nuance.html";v3Lander.establishHostedFileURL();if(window.location.href.indexOf("surveys/launchNativePostChatSurvey")>-1){(v3Lander).isAtHostedFileURL=window.location.href.indexOf("hostedFileURL=true")>-1;}else{(v3Lander).isAtHostedFileURL=window.location.href.indexOf(v3Lander.hostedFileURL)>-1;}
(v3Lander).assignDomain();if(window.location.href.indexOf("?BLNK")!=-1){}
else if(window.location.href.indexOf("?CCFRM")!=-1){var host=(window.v3LanderConfig.vanityDomain||"https://hm.inq.com").replace(/^https?:\/\//,"");var url="http://"+window.document.domain+"/tagserver/ccform/getCreditCardForm?host="+host;window.location.replace(url);}
else if(window.location.href.indexOf("?CCTKN=1")!=-1){var s=document.createElement("script");var params=v3Lander.encodeURLIfNotEncoded(window.location.href.replace(/^.*\?/,"?"));var src=(window.v3LanderConfig.vanityDomain||"https://hm.inq.com")+"/tagserver/cctoken/getToken"+params;s.src=src;document.head.appendChild(s);}
else if(window.location.href.indexOf("?CCTKN=2")!=-1){var s=document.createElement("script");var params=v3Lander.encodeURLIfNotEncoded(window.location.href.replace(/^.*\?/,"?"));var src=(window.v3LanderConfig.vanityDomain||"https://hm.inq.com")+"/tagserver/cctokentest/getToken"+params;s.src=src;document.head.appendChild(s);}
